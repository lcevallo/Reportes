...
@NamedQueries({
    ...
    @NamedQuery(name = "LcTblCxp.findByTipo", query = "SELECT l FROM LcTblCxp l WHERE l.tipo = :tipo"),
    ...
    @NamedQuery(name = "LcTblCxp.findByAcarreo", query = "SELECT l FROM LcTblCxp l WHERE l.acarreo = :acarreo"),
    @NamedQuery(name = "LcTblCxp.findByLineaAcarreo", query = "SELECT l FROM LcTblCxp l WHERE l.lineaAcarreo = :lineaAcarreo"),
...
public class LcTblCxp implements Serializable {
    ...
    @Column(name = "ACARREO")
    private BigDecimal acarreo;
    @Column(name = "LINEA_ACARREO")
    private Integer lineaAcarreo;
    @Size(max = 110)
    @Column(name = "DES")
    private String des;
    @Size(max = 20)
    ...
    public BigDecimal getAcarreo() {
        return acarreo;
    }

    public void setAcarreo(BigDecimal acarreo) {
        this.acarreo = acarreo;
    }

    public Integer getLineaAcarreo() {
        return lineaAcarreo;
    }

    public void setLineaAcarreo(Integer lineaAcarreo) {
        this.lineaAcarreo = lineaAcarreo;
    }
